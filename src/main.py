from src.job_list_parser import JobListParser
from src.playwright_mcp_client import PlaywrightMCPClient
from src.llm_providers import llm_openai, llm_ollama
from src.job_agent import JobApplicationAgent
import asyncio
...
async def main(url: str):
    ...
    agent = JobApplicationAgent(mcp_client, llm_ollama, job_url)
    await agent.invoke()
